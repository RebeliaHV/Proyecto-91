...
function car2_down(){
	if(car2_y <= 500){
		car2_y = car2_y + 10;
		console.log("Cuando se presione la flecha s, x = " + car2_x + "| y =" + car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_up(){
	if(car2_y >= 0){
		car2_y = car2_y - 10;
		console.log("Cuando se presione la flecha w, x = " + car2_x + "| y =" + car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
     }
...
function car2_left(){
	if(car2_x >= 0){
		car2_x = car2_x - 10;
		console.log("Cuando se presione la flecha a, x = " + car2_x + "| y =" + car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
     }
...
function car2_right(){
	if(car2_x <= 700){
		car2_x = car2_x + 10;
		console.log("Cuando se presione la flecha d, x = " + car2_x + "| y =" + car2_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
     }
